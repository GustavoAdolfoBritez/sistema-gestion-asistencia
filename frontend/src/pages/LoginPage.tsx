...
export function LoginPage({ onLoginSuccess, onOpenLegalPage }: LoginPageProps) {
  ...
  return (
    <div className="login-shell-bg min-h-screen w-full max-w-full overflow-x-hidden">
      <div className="flex min-h-screen w-full min-w-0 flex-col items-center justify-center px-4 py-6 max-lg:min-h-[100dvh] max-lg:justify-center max-lg:px-4 max-lg:py-8 max-lg:pb-[max(2rem,env(safe-area-inset-bottom))] max-lg:pt-[max(2rem,env(safe-area-inset-top))] sm:px-6 sm:py-8 lg:px-8">
