...
function measurePlanillaNombreRowHeight(doc, nombre) {
...
function drawHeader(doc, data) {
    const inst = (0, pdf_institutional_header_planilla_1.drawInstitutionalHeaderPlanillaLegal)(doc, PAGE_SIZE[0], pdf_institutional_header_planilla_1.PDF_INSTITUTIONAL_HEADER_TOP);
...
function drawTableHeader(doc, startY, data) {
...
function drawRows(doc, startY, data) {
    let currentY = startY;
    let rowIndex = 0;
