...
const envSchema = zod_1.z.object({
    ...
    SUPABASE_URL: zod_1.z.string().url('Falta SUPABASE_URL (API de Supabase)'),
    SUPABASE_SERVICE_ROLE_KEY: zod_1.z.string().min(1, 'Falta SUPABASE_SERVICE_ROLE_KEY para Storage'),
...
const { NODE_ENV: _node, CORS_ORIGINS: _cors, EXPOSE_ERROR_DETAILS: _exp, DB_STATEMENT_TIMEOUT_MS: _stmto, SUPABASE_URL: supabaseUrl, SUPABASE_SERVICE_ROLE_KEY: supabaseServiceRoleKey, ...rest } = parsed.data;
exports.env = {
    ...rest,
    NODE_ENV,
    corsOrigins,
